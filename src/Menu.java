...
public class Menu extends JFrame {
	...
	public void existingCustomer() {
		...
		while (loop2) {
			...
			if (!customer.getPassword().equals(customerPassword))// check
																	// if
																	// custoemr
																	// password
																	// is
	...
	public void summary() {
		...
		for (int a = 0; a < customerList.size(); a++)// For each
														// customer, for
														// each account,
														// it displays
														// each
				...
				if (found == false) {
					...
					if (account.equals("Current Account")) {
						...
						String number = String.valueOf(
								"C" + (customerList.indexOf(customer) + 1) * 10 + (customer.getAccounts().size() + 1));// this
																														// simple
																														// algorithm
																														// generates
																														// the
					...
					if (account.equals("Deposit Account")) {
						...
						String number = String.valueOf(
								"D" + (customerList.indexOf(customer) + 1) * 10 + (customer.getAccounts().size() + 1));// this
																														// simple
																														// algorithm
																														// generates
																														// the
